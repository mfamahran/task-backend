                        ...
                        <form method="post" action="{{ route('category.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('parent_id') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-parent">{{ __('Parent Category') }}</label>
                                    <select name="parent_id" id="input-parent" class="form-control form-control-alternative{{ $errors->has('parent') ? ' is-invalid' : '' }}" placeholder="{{ __('Parent Category') }}" value="{{ old('parent_id') }}">
